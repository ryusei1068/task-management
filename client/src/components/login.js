...
function Login(props) {
  ...
  const formSubmit = (e, path) => {
    ...
    API.post(path, data)
      ...
      .catch(() => { props.authenticate(false); })
  }
            ...
            <Form>
              ...
              <Form.Group className="mb-3">
               ...
               <div className = "d-flex">
                 < Button variant = "outline-secondary" id = "signup" 
                   onClick = {(e) => formSubmit(e, "/signup")}>Sign Up</Button>
                 <Button className="mx-2 px-3" variant="outline-secondary" id="login" 
                   onClick={(e) => formSubmit(e, "/login")}>Login</Button>
               </div>
            </Form>
          </div>
        </div>
